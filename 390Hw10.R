...
#different means. To test that more objectively, perform an appropriate test, report the pvalue, and state your conclusion, at alpha = 0.05.
# b) Perform the appropriate test if we want to see whether SSE_vld4 is less than
#SSE_vld8. Report the p-value, and state your conclusion, at alphs = 0.05 .
